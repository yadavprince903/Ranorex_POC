...
namespace MyCRM.Recordings.Company.RG_005
{
...
#region Variables
        ...
        /// </summary>
        [TestVariable("f40fc6ac-8b50-4a75-8d12-7677be9225a4")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$AddLine2' with focus on 'MyCRM.Company.TxtAddressLine2'.", repo.MyCRM.Company.TxtAddressLine2Info, new RecordItemIndex(5));
            repo.MyCRM.Company.TxtAddressLine2.PressKeys(AddLine2);
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Main' with focus on 'MyCRM.Company.TxtMain'.", repo.MyCRM.Company.TxtMainInfo, new RecordItemIndex(11));
            repo.MyCRM.Company.TxtMain.PressKeys(Main);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Main) on item 'MyCRM.Company.TxtMain'.", repo.MyCRM.Company.TxtMainInfo, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.MyCRM.Company.TxtMainInfo, "Text", Main);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Other' with focus on 'MyCRM.Company.TxtOther'.", repo.MyCRM.Company.TxtOtherInfo, new RecordItemIndex(13));
            repo.MyCRM.Company.TxtOther.PressKeys(Other);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Other) on item 'MyCRM.Company.TxtOther'.", repo.MyCRM.Company.TxtOtherInfo, new RecordItemIndex(14));
            Validate.AttributeEqual(repo.MyCRM.Company.TxtOtherInfo, "Text", Other);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Comments' with focus on 'MyCRM.Company.CommentBox'.", repo.MyCRM.Company.CommentBoxInfo, new RecordItemIndex(15));
            repo.MyCRM.Company.CommentBox.PressKeys(Comments);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Comments) on item 'MyCRM.Company.CommentBox'.", repo.MyCRM.Company.CommentBoxInfo, new RecordItemIndex(16));
            Validate.AttributeEqual(repo.MyCRM.Company.CommentBoxInfo, "Text", Comments);
            Delay.Milliseconds(0);
